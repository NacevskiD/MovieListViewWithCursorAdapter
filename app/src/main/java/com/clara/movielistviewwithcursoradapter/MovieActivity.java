...
public class MovieActivity extends AppCompatActivity implements MovieCursorAdapter.RatingChangedListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		yearReleased = (EditText) findViewById(R.id.year_released_editText);
		...
		addNew.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Date date = new Date();
				dbManager.addMovie(name, rating,year,date.toString());   //TODO detect errors and handle appropriately
