...
public class DatabaseManager {
	...
	protected static final String YEAR_COL = "year";
	...
	public void dropTable(){
		String drop = "DROP TABLE " + DB_TABLE;

		db.execSQL(drop);
	}

	void createTable(){
		String createSQLbase = "CREATE TABLE IF NOT EXISTS %s ( %s INTEGER PRIMARY KEY AUTOINCREMENT, %s TEXT UNIQUE, %s FLOAT, %s INT, %s STRING )";
		String createSQL = String.format(createSQLbase, DB_TABLE, ID_COL, MOVIE_NAME_COL, MOVIE_RATING_COL, YEAR_COL,DATE_COL);
	...
	public boolean addMovie(String name, float rating,int year, String date) {
		ContentValues newProduct = new ContentValues();
		newProduct.put(MOVIE_NAME_COL, name);
		newProduct.put(MOVIE_RATING_COL, rating);
		newProduct.put(YEAR_COL, year);
	...
	public class SQLHelper extends SQLiteOpenHelper {
		...
		public void onCreate(SQLiteDatabase db) {
			String createSQLbase = "CREATE TABLE %s ( %s INTEGER PRIMARY KEY AUTOINCREMENT, %s TEXT UNIQUE, %s FLOAT, %s INT, %s STRING )";
			String createSQL = String.format(createSQLbase, DB_TABLE, ID_COL, MOVIE_NAME_COL, MOVIE_RATING_COL, YEAR_COL,DATE_COL);
			db.execSQL(createSQL);
		}
